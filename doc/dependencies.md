...
These are the dependencies currently used by Scholarship Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| FreeType | [2.7.1](https://download.savannah.gnu.org/releases/fschoype) |  | No |  |  |
...
Telegram - https://t.me/scholarshipnl
Keybase  - https://keybase.io/team/scholarship/
