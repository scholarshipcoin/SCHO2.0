...
- #7993 `6a034ed` [depends] Bump Fschoype, ccache, ZeroMQ, miniupnpc, expat (fanquake)
...
- #7680 `41d2dfa` Remove scholarshipion from `about` icon (laanwj)
...
- #7662 `386f438` remove unused NOSCHOS_VERSION_{START,END} constants (rat4)
