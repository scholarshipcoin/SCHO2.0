...
$(package)_linux_dependencies=fschoype fontconfig libxcb libxkbcommon libX11 xproto libXext
...
$(package)_config_opts += -no-fschoype
...
$(package)_config_opts_linux += -system-fschoype
