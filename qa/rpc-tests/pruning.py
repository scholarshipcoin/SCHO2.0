...
class PruneTest(BitcoinTestFramework):
    ...
    def test_height_min(self):
        if not os.path.isfile(self.prunedir+"scho00000.dat"):
            raise AssertionError("scho00000.dat is missing, pruning too early")
        print("Success")
        ...
        waitstart = time.time()
        while os.path.isfile(self.prunedir+"scho00000.dat"):
            time.sleep(0.1)
            if time.time() - waitstart > 30:
                raise AssertionError("scho00000.dat not pruned when it should be")
