...
const QString BITCOIN_IPC_PREFIX("scholarship:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/scholarship-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/scholarship-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/scholarship-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click scholarship: links
...
//
// OSX-specific way of handling scholarship: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in scholarship: URIs
