...
QT_TRANSLATE_NOOP("bitcoin-core", "Imports blocks from external scho000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Rebuild chain state and block index from the scho*.dat files on disk"),
