...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in scho*.dat
...
public:
    ...
    //! Which # file this block is stored in (scho?????.dat)
    int nFile;

    //! Byte offset within scho?????.dat where this block's data is stored
