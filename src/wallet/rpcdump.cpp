...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"scholarshipaddress\"\n"
            "\nReveals the private key corresponding to 'scholarshipaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"scholarshipaddress\"   (string, required) The scholarship address for the private key\n"
            "\nResult:\n"
