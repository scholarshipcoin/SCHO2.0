...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Scholarshipcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Scholarshipcoin
    // Mac: ~/Library/Application Support/Scholarshipcoin
    // Unix: ~/.scholarship
#ifdef WIN32
    // Windows
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    std::string strCopyrightHolders =
        ...
        "\n" + strPrefix + "The Scholarship developers" +
        "\n" + strPrefix + "The Scholarship Core developers";
